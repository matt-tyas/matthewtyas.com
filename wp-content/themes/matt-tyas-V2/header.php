...
<!--[if (gte IE 9)|(gt IEMobile 7)|!(IEMobile)|!(IE)]><!--><html <?php language_attributes(); ?> class="no-js"><!--<![endif]-->
	...
	<body <?php body_class(); ?>>
		<div id="container">
			...
			<h1>
			    <a id="logo-home-link" href="<?php echo home_url(); ?>" rel="nofollow">   
			    M<span>atthew</span> T<span>yas web designer front end developer and co-owner of manchestersfinest.com</span>
			    <!--<img src="<?php // echo get_option('siteurl'); ?>/wp-content/themes/matt-tyas-V2/library/images/mtyas-banner.png"  alt="<?php // bloginfo('name'); ?>" />-->
				</a>
			</h1>
