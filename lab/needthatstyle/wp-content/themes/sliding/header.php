...
<div id="wrapper">
	...
	<header id="header" class="col-full">
		...
		<div id="search-top">
	    	...
	    	<form role="search" method="get" id="searchform" class="searchform" action="<?php echo home_url(); ?>">
				...
				<input type="image" class="submit btn search" name="submit" value="<?php _e('Search', 'woothemes'); ?>" src="<?php echo get_template_directory_uri(); ?>/images/ico-search-grad.png" alt="Search">
	...
	<nav id="navigation" class="col-full" role="navigation">
        ...
        <ul class="header-social-networks fr">
        	<li><a href="http://twitter.com/Needthatstyle" target="_blank" class="twitter hide" title="Visit Need that Style on Twitter">twitter</a></li>
        	<li><a href="http://en-gb.facebook.com/needthatstylee" target="_blank" class="facebook hide" title="Visit Need that Style on Facebook">facebook</a></li>
        </ul>
        <!-- <ul class="rss fr">
        	<li>twitter</li>
        	<li>facebook</li>
