    ...
    <div class="post full">
      ...
      <div class="gallery2">
        ...
        <?php query_posts('post_type='.$posttype.'&posts_per_page=-1'); ?>
    		...
    		<li><div class="imgbg"><a href="<?php echo $image_url; ?>" title="<?php the_title(); ?>" rel="prettyPhoto[<?php echo $posttype; ?>]"><img src="<?php echo $themePath ?>/inc/timthumb.php?src=<?php echo $image_url; ?>&w=450&h=250&zc=1&q=100" alt="<?php the_title(); ?>" width="450" height="250" /></a></div>
            	<h3><?php the_title(); ?></h3>
                <div class="date"><strong><?php the_time('F jS, Y') ?></strong></div> 
                <p><?php the_content(); ?></p>
            </li>
    	<?php endwhile; else: ?>
		<?php endif; ?>
