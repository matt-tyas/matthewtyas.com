...
<body class="login">
<?php   if ( !is_multisite() ) { ?>
<div id="login"><h1><a href="<?php echo apply_filters('login_headerurl', 'http://stylographicdesign.co.uk'); ?>" title="<?php echo apply_filters('login_headertitle', esc_attr__('Powered by Stylographic')); ?>"><?php bloginfo('name'); ?></a></h1>
<?php   } else { ?>
