...
function spawn_cron( $local_time = 0 ) {
    ...
    */
    ...
    // The above replaced by one-click install to work around block on HTTP callbacks on
    ...
    // End of replace by one-click install to work around block on HTTP callbacks on
    // servers that firewall block calls to themselves.
