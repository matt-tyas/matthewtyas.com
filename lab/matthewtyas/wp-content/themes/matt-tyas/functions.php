...
//jQuery Insert From Google - correct for WP3.3
...
return 18; // Or whatever you want the length to be.
}
...
add_image_size( 'homepage-thumbnail-180-160', 180, 160, true );
/* 
...
function bones_register_sidebars() {
	...
	register_sidebar(array(
		...
		'before_widget' => '<div id="%1$s" class="widget %2$s col25">',
		'after_widget' => '</div>',
		'before_title' => '<h4><span>',
		'after_title' => '</span></h4>',
	));
